...
void handle_chtcp_xmit_received (const event_t *e)
...
void log_chtcp_xmit_received (FILE *f,const event_t *e)
{
    const tcp_xmit_received_t *txr = (const tcp_xmit_received_t *)e;
...
void handle_chtcp_reception_complete (const event_t *e)
...
void log_chtcp_reception_complete (FILE *f,const event_t *e)
{
